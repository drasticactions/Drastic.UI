...
{
	using FormsImageButton = UI.ImageButton;

	public static class ImageButton
	{
		#region Shadow
		public static readonly BindableProperty IsShadowEnabledProperty = BindableProperty.Create("IsShadowEnabled", typeof(bool), typeof(UI.ImageButton), false);
