namespace Drastic.UI.PlatformConfiguration.AndroidSpecific
{
	...
	public static class Entry
	{
		...
		public static IPlatformElementConfiguration<Android, FormsElement> SetImeOptions(this IPlatformElementConfiguration<Drastic.UI.PlatformConfiguration.Android, FormsElement> config, ImeFlags value)
		{
