...
namespace Drastic.UI.PlatformConfiguration.iOSSpecific
{
	...
	public static class MasterDetailPage
	{
		...
		public static IPlatformElementConfiguration<iOS, UI.MasterDetailPage> SetApplyShadow(this IPlatformElementConfiguration<iOS, UI.MasterDetailPage> config, bool value)
		{
			SetApplyShadow(config.Element, value);
			return config;
		}

		public static bool GetApplyShadow(this IPlatformElementConfiguration<iOS, UI.MasterDetailPage> config)
		{
			return GetApplyShadow(config.Element);
		}
		#endregion
