...
namespace Drastic.UI.Platform.iOS
{
	public class CarouselViewController : ItemsViewController<CarouselView>
	{
		...
		void BoundsSizeChanged() 
		{
			...
			Carousel.ScrollTo(Carousel.Position, position: Drastic.UI.ScrollToPosition.Center, animate: false);
		}
		...
		{	
			...
			if (_gotoPosition == -1 && (goToPosition != carouselPosition || forceScroll))
			{
				...
				Carousel.ScrollTo(goToPosition, position: Drastic.UI.ScrollToPosition.Center, animate: animate);
			}
		}
		...
		void UpdateInitialPosition()
		{
			...
			if (!_initialPositionSet)
			{
				...
				Carousel.ScrollTo(position, -1, Drastic.UI.ScrollToPosition.Center, false);
			}
