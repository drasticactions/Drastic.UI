...
using Drastic.UI.Platform.macOS.Extensions;
...
#endif
{
	...
	public class VisualElementRenderer<TElement> : NativeView, IVisualElementRenderer, IEffectControlProvider where TElement : VisualElement
	{
		...
		{
			Drastic.UI.Layout.LayoutChildIntoBoundingRegion(Element, new Rectangle(Element.X, Element.Y, size.Width, size.Height));
		}
		...
		{
			var menu = Drastic.UI.Element.GetMenu(Element);
		...
		protected virtual void OnElementPropertyChanged(object sender, PropertyChangedEventArgs e)
		{
			if (e.PropertyName == VisualElement.BackgroundColorProperty.PropertyName)
				...
				SetBackground(Element.Background);
			else if (e.PropertyName == Drastic.UI.Layout.IsClippedToBoundsProperty.PropertyName)
				UpdateClipToBounds();
