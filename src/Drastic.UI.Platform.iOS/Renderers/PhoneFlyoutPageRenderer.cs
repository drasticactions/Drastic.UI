	...
	public class PhoneFlyoutPageRenderer : UIViewController, IVisualElementRenderer, IEffectControlProvider
	{
		...
		bool Presented
		{
			...
			set
			{
				...
				((IElementController)Element).SetValueFromRenderer(Drastic.UI.FlyoutPage.IsPresentedProperty, value);
			}
		}
		...
		void UpdateFlyoutPageContainers()
		{
			...
			detailRenderer.ViewController.View.Superview.BackgroundColor = Drastic.UI.Color.Black.ToUIColor();
