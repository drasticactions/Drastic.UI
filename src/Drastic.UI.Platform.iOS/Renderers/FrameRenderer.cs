	...
	public class FrameRenderer : VisualElementRenderer<Frame>, ITabStop
	{
		...
		protected override void OnElementPropertyChanged(object sender, PropertyChangedEventArgs e)
		{
			...
			if (e.PropertyName == VisualElement.BackgroundColorProperty.PropertyName ||
				...
				e.PropertyName == Drastic.UI.Frame.BorderColorProperty.PropertyName ||
				e.PropertyName == Drastic.UI.Frame.HasShadowProperty.PropertyName ||
				e.PropertyName == Drastic.UI.Frame.CornerRadiusProperty.PropertyName ||
				e.PropertyName == Drastic.UI.Frame.IsClippedToBoundsProperty.PropertyName ||
