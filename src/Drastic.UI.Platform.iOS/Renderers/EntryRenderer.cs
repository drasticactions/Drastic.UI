...
using Specifics = Drastic.UI.PlatformConfiguration.iOSSpecific.Entry;
		...
		where TControl : UITextField
	{
		...
		protected override void OnElementPropertyChanged(object sender, PropertyChangedEventArgs e)
		{
			...
			else if (e.IsOneOf(Entry.TextProperty, Entry.TextTransformProperty))
			{
				...
				UpdateCharacterSpacing();
			else if (e.PropertyName == Drastic.UI.InputView.KeyboardProperty.PropertyName)
				UpdateKeyboard();
			else if (e.PropertyName == Drastic.UI.InputView.IsSpellCheckEnabledProperty.PropertyName)
				UpdateKeyboard();
			...
			else if (e.PropertyName == VisualElement.IsEnabledProperty.PropertyName)
			{
				...
				UpdateHorizontalTextAlignment();
			else if (e.PropertyName == Drastic.UI.InputView.MaxLengthProperty.PropertyName)
				UpdateMaxLength();
				...
				UpdateCursorColor();
			else if (e.PropertyName == Drastic.UI.InputView.IsReadOnlyProperty.PropertyName)
				UpdateIsReadOnly();
		...
		void UpdateKeyboard()
		{
			...
			{
				if (Element.IsSet(Drastic.UI.InputView.IsSpellCheckEnabledProperty))
				{
				...
				if (Element.IsSet(Drastic.UI.Entry.IsTextPredictionEnabledProperty))
				{
